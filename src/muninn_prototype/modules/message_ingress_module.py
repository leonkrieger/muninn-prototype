...
class MessageIngressModule(BaseModule):
    ...
    def _on_message(self, topic: str, payload: str) -> None:
        pub.sendMessage("messages", message=InboundMessage(topic, payload))
    ...
    def initiate(self, configuration: dict[str, Any] | None = None) -> None:
        ...
        if self._adapter is None:
            pub.sendMessage("error", message="No message ingress adapter available", error_code="ingress_unavailable")
            return
